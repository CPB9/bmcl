...
OP_TEST(add_float, float, AddFloat, -12.1234f, 45.09875f, 32.97535f);
...
OP_TEST(sub_float, float, SubFloat, 3.234f, 13.234f, 10.0f);
...
OP_TEST(mult_float, float, MultFloat, 2.23f, 4.876f, 10.87348f);
...
OP_TEST(div_float, float, DivFloat, 8.88f, 2.22f, 0.25f);
